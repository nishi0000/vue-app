 ...
 * limitations under the License.
 */
function md(e){e=fh(e,vh);const t=fh(e.firestore,Th);return ih(Sh(t),e._key).then((n=>bd(t,e,n)))}class yd extends ud{constructor(e){super(),this.firestore=e}convertBytes(e){return new Ah(e)}convertReference(e){const t=this.convertDocumentKey(e,this.firestore._databaseId);return new vh(this.firestore,null,t)}}function vd(e){e=fh(e,yh);const t=fh(e.firestore,Th),n=Sh(t),r=new yd(t);return Jh(e._query),sh(n,e._query).then((n=>new pd(t,r,e,n)))}function wd(e,t){const n=fh(e.firestore,Th),r=bh(e),i=ld(e.converter,t);return _d(n,[Uh(Mh(e.firestore),"addDoc",r._key,i,null!==e.converter,{}).toMutation(r._key,oa.exists(!1))]).then((()=>r))}function _d(e,t){return function(e,t){const n=new ai;return e.asyncQueue.enqueueAndForget((async()=>Ol(await nh(e),t,n))),n.promise}(Sh(e),t)}function bd(e,t,n){const r=n.docs.get(t._key),i=new yd(e);return new dd(e,i,t._key,r,new hd(n.hasPendingWrites,n.fromCache),t.converter)}
/**
 * @license
 * Copyright 2022 Google LLC
 *
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */function Ed(){return new Fh("serverTimestamp")}new WeakMap;
/**
 * @license
 * Copyright 2023 Google LLC
 *
...
//# sourceMappingURL=chunk-vendors.15932637.js.map